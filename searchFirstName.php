...
function searchUser($userData, $conn, $database){
	...
	$sql = "SELECT first_name, last_name, email, home_phone, cell_phone, home_address FROM MovieUser WHERE first_name LIKE '%" . $conn->real_escape_string($userData['first_name']). "%'";
